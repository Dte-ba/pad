...
routes.tags = require('./tags.js');
routes.arbor = require('./arbor.js');
routes.nodes = require('./nodes.js');
routes.stats = require('./stats.js');
routes.bienvenido = require('./bienvenido.js');
routes.transversales = require('./transversales.js');
routes.orientacion = require('./orientacion.js');
