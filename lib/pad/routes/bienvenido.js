...
function bienvenido(req, res){
  ...
  var vm = {
    ...
    aHref: (view === 'Acerca de' ? 'active' : '/bienvenido/Acerca de'),
    mHref: (view === 'Marco General' ? 'active' : '/pad/files/PAD con nomina y bibliografia.pdf'),
    eHref: (view === 'Encuadre' ? 'active' : '/bienvenido/Encuadre'),
